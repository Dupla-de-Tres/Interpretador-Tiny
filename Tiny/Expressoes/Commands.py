# Comandos apenas para processamento

from Expressoes.Expressions import Expr
from Expressoes.Expressions import Variable
...
class Command:
    ...
    def executar(): #Método abstrato da classe Command
        pass
